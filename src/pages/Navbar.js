...
const Navbar = ({accounts , setaccounts,connectwallet}) => {
    ...
    return (
        ...
        <Flex justify= "space-between" padding="15px"  bg="white" >
                ...
                <HStack spacing="50" justify="space-between" position= "sticky"  >
                    <Button as={Link} varient="link" backgroundColor= "white" to="/home" fontSize="20px" fontWeight="bold" > Home</Button>
            ...
            {/* Connect button*/}
            {iswalletconnected ? (
                <Box as='button' backgroundColor="lightgreen" borderRadius= "100px" width="10%" height="45px" fontStyle="bold" fontSize={20}> {accounts[0].slice(0, 5) + '...' + accounts[0].slice(38, 42)}</Box>
